...
export class MkCentralTournamentsApi {
  ...
  transformTournament(raw) {
    ...
    // Build logo URLs - Direct URL pattern from mkcentral.com
    // Tournament-specific logo: https://mkcentral.com/img/tournament_logos/{event_id}.png
    // Series logo: https://mkcentral.com/img/series_logos/{series_id}.png
    const tournamentLogo = `${this.imgBaseUrl}/tournament_logos/${raw.event_id}.png`;
    const seriesLogo = raw.tournament_series_id 
      ? `${this.imgBaseUrl}/series_logos/${raw.tournament_series_id}.png` 
      : null;
    ...
    return {
      ...
      // Media - Tournament logo is the primary, series logo as fallback
      logo: tournamentLogo,
